...
intervention_length_name <- "_testing_clean_code_uncertainty"
...
### Observations - uncertainty in delay and undersampling. A value of 0 means no uncertainty. ###
      delay_distr_mean_std = .1, #the percent uncertainty in the mean of the delay distribution - specify a single value
      delay_distr_std_std = .1, #the percent uncertainty in the std of the delay distribution - specify a single value
...
### Misspecification in observation distributions. A value of 1 means no misspecification. ###
      delay_distr_mean_mult = 1.1, #multiplier for how much to misspecify delay distribution mean - specify a single value
      delay_distr_std_mult = 1.1, #multiplier for how much to misspecy delay distribution std - specify a single value
      frac_sampled_mean_mult = 1, #multiplier for how much to misspecify fraction sampled - specify a single value
...
init_delay_distr_vec <- tabulate(obs_delays_with_uncertainty(1000000, assumed_mean, assumed_mean_std, assumed_std, assumed_std_std, assumed_time_to_obs, assumed_time_to_obs_std*100))
