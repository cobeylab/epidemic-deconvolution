...
* Unobserved states have independent priors whose scale is inferred;
  the scale has a half-normal prior whose scale is equal to the largest value
...
(Should just take 10 seconds or so.)
...
I think the estimates tip up at the end simply because the intervals are wide, driven by the prior alone.
