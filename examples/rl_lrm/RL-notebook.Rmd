...
intervention_length_name <- "_62_obs_1_inferred_minus_2_hack"
...
if (file.exists(sprintf("%s/params.Rds", intervention_file_name))) {
  ...
  parlist <- {
    list(
      ...
      intervention_time_1 = 83, # Timepoint at which intervention starts (at which underlying transmission rate begins to fall)
      intervention_time_2 = 83+200,
